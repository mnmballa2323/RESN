class ListFurnituresController < ApplicationController
  ...
  def new
    @list_furniture = ListFurniture.new
  end
  ...
  def create
    @list_furniture = ListFurniture.new(list_furniture_params)

    respond_to do |format|
      if @list_furniture.save
        format.html { redirect_to @list_furniture, notice: 'List furniture was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @list_furniture.update(list_furniture_params)
        format.html { redirect_to @list_furniture, notice: 'List furniture was successfully updated.' }
  ...
  private
    ...
    def list_furniture_params
      params.require(:list_furniture).permit(:title, :price, :url, :type, :size, :material, :total_no)
    end
end
